...
import { FacebookLogo, GoogleChromeLogo, InstagramLogo, TwitterLogo, YoutubeLogo } from '@phosphor-icons/react'
    ...
    <div>
      <div className='bg-[#181818]'>
        <div className='py-[60px] grid grid-cols-5 container mx-auto'>
          <div className='px-4'>
            <h5 className=' text-base text-white mb-5 font-medium'>Information</h5>
          ...
          <div className='px-4'>
            <h5 className=' text-base text-white mb-5 font-medium'>Extras</h5>
            <div className='font-light text-sm text-[#a7a7a7]'>
          ...
          <div className='px-4'>
            <h5 className=' text-base text-white mb-5 font-medium'>My Account</h5>
            <div className='font-light text-sm text-[#a7a7a7]'>
          ...
          <div className='px-4'>
            <h5 className=' text-base text-white mb-5 font-medium'>Quick Links</h5>
            <div className='font-light text-sm text-[#a7a7a7]'>
          ...
          <div className='px-4'>
            <h5 className=' text-base text-white mb-5 font-medium'>Contact</h5>
            <div className='font-light text-sm text-[#a7a7a7]'>
              <a href="#" className='block mb-2'>Portable - Mega Store United States</a>
              <a href="#" className='block mb-2'>000-000-0000</a>
              <a href="#" className='block mb-2'>123456</a>
              <a href="#" className='block mb-2'>sales@yourcompany.com</a>
            </div>
          </div>
        </div>
      </div>
